      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 h-screen w-full">
        <div className="bg-gray-800 flex flex-col justify-center">
          ...
          >
            ...
            {errors.username && (
              <p className="text-red-500">Please Check Username</p>
            )}
            ...
            {errors.password && (
              <p className="text-red-500">Please Check Password</p>
            )}
            <div className="field flex flex-col text-gray-400 py-2">
            ...
            {errors.confirmpassword && (
              <p className="text-red-500">Please Check Confirm Password</p>
            )}
            <button
              onClick={registers}
              type="submit"
